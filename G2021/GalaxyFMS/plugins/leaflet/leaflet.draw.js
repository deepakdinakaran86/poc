...
!function(t, e) {
    ...
    L.Draw.Polyline = L.Draw.Feature.extend({
        ...
        addVertex: function(t) {
            ...
            void 0) : (this._errorShown && this._hideErrorTooltip(),
    ...
    L.Draw.Polygon = L.Draw.Polyline.extend({
        ...
        _getTooltipText: function() {
            var t, e;
            return 0 === this._markers.length ? t = L.drawLocal.draw.handlers.polygon.tooltip.start : this._markers.length < 3 ? t = L.drawLocal.draw.handlers.polygon.tooltip.cont : (t = L.drawLocal.draw.handlers.polygon.tooltip.end,
    ...
    L.Edit.Poly = L.Handler.extend({
        ...
        _onMarkerClick: function(t) {
            var e = L.Polygon && this._poly instanceof L.Polygon ? 4 : 3
              , i = t.target;
            this._poly._latlngs.length < e || (this._removeMarker(i),
    ...
    L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
        ...
        readableArea: function(t, e) {
            var i;
            return e ? i = t >= 1e4 ? (1e-4 * t).toFixed(2) + " ha" : t.toFixed(2) + " m&sup2;" : (t *= .836127,
            i = t >= 3097600 ? (t / 3097600).toFixed(2) + " mi&sup2;" : t >= 4840 ? (t / 4840).toFixed(2) + " acres" : Math.ceil(t) + " yd&sup2;"),
            i
        },
    ...
    L.Toolbar = L.Class.extend({
        ...
        addToolbar: function(t) {
            ...
            return o ? (this._lastButtonIndex = --o,
        ...
        _createActions: function(t) {
            ...
            for (i = 0,
            o = this._actionButtons.length; o > i; i++)
    ...
    L.Tooltip = L.Class.extend({
        ...
        updatePosition: function(t) {
            var e = this._map.latLngToLayerPoint(t)
              , i = this._container;
            return this._container && (i.style.visibility = "inherit",
    ...
    L.EditToolbar = L.Toolbar.extend({
        ...
        initialize: function(t) {
            t.edit && ("undefined" == typeof t.edit.selectedPathOptions && (t.edit.selectedPathOptions = this.options.edit.selectedPathOptions),
