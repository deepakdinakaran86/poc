...
function FnResAssetList(response){	
	...
	var PointMapLink = (ObjPageAccess['mappoint']=='1') ? " &nbsp  &nbsp  <a class='grid-asset-mappoints btn btn-sm btn-raised default' data-toggle='tooltip' data-placement='left' title='Map points'><i class='fa fa-link' style='color:darkcyan'></i></a>" : "";
	var Actionlink = (ObjPageAccess['dashboard']=='1') ? '<a  href="javascript:void(0);" class="grid-asset-dashboard btn btn-sm btn-raised default"  data-toggle="tooltip" data-placement="bottom"  title="Asset dashboard"><i class="fa fa-tachometer" style="color:darkcyan"></i></a>' : "";
...
function FnGetGridColumns(){
	...
	var ViewLink = (ObjPageAccess['view']=='1') ? "<a class='grid-asset-view capitalize'>#=assetName#</a>" : "<a href='Javascript:void(0)' class='capitalize'>#=assetName#</a>";
	
	var PointMapLink = (ObjPageAccess['mappoint']=='1') ? " &nbsp  &nbsp &nbsp <a class='grid-asset-mappoints btn btn-sm btn-raised default' data-toggle='tooltip' data-placement='left' title='Map points'>Map Points</a>" : "";
	
	var VarActionsLink = '<div class="asset-actions">';
	VarActionsLink += '<a  href="javascript:void(0);" class="grid-asset-dashboard"  data-toggle="tooltip" data-placement="bottom" title="Asset Dashboard"><i class="fa fa-tachometer"></i></a>'+PointMapLink;
	VarActionsLink += '</div>';
