...
function FnGetAllFaultList(){
	...
	FnMakeAjaxRequest(VarUrl, 'GET', '', 'application/json; charset=utf-8', 'json', FnResAllFaultList);
}
...
function FnResAllFaultList(response){
	...
	if(VarResLength > 0){
		...
		$("#gapp-faults-list").data("kendoGrid").tbody.on("click", "#grid-viewfaultdetails", function(e) {
			...
			//
			//VarIdentifier = "c8772610-6c8d-4b86-8155-8218b532ae3d";
			//var VarUrl = 'https://10.234.60.41:9444/portal/ajaxccd/ccd1/1.0.0/receiveData/{fault_event_id}/response';
