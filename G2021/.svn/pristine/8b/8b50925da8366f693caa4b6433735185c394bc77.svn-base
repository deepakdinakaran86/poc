					...
					if(ArrParameters[i].name == 'Location'){
						...
						if (undefined !== ArrParameters[i].value && !$.isEmptyObject(ArrParameters[i].value)){
							...
							if(typeof ArrParameters[i].value == "string"){
								locLatLng = $.parseJSON(stripSlashes(ArrParameters[i].value));
							}else if(typeof ArrParameters[i].value == "object"){
								locLatLng = ArrParameters[i].value;
							}
						...
						if (undefined !== ArrParameters[i].value && typeof ArrParameters[i].value == "string"){
							locLatLng = stripquotes(ArrParameters[i].value)
						}
						item.set('value', locLatLng);
					}
