 ...
 */
public class FaultResponseMessageUtil implements Runnable{
	
	private KafkaStream kafkaStream;
	private int threadNo;
	
	public FaultResponseMessageUtil(KafkaStream stream,int threadNo){
		kafkaStream = stream;
	...
	private void faultResponse(String msg){
