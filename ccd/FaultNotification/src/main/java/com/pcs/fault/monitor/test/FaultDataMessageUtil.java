 ...
 */
public class FaultDataMessageUtil implements Runnable{
	
	private KafkaStream kafkaStream;
	private int threadNo;
	
	public FaultDataMessageUtil(KafkaStream stream,int threadNo){
		kafkaStream = stream;
	...
	private void faultEvent(String msg) throws JsonParseException, JsonMappingException, IOException{
		...
		try {
           ...
           FaultAnalyzeBolt analyzeBolt = new FaultAnalyzeBolt();
            analyzeBolt.checkFautlt(faultData1,msg);
