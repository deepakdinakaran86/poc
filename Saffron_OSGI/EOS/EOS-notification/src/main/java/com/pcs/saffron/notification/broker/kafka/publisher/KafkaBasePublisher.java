 ...
 * @date March 23 2015
 */
public class KafkaBasePublisher extends CorePublisherAdapter{

	private static final long serialVersionUID = -8318316434070289980L;

	private static final Logger LOGGER = LoggerFactory.getLogger(KafkaBasePublisher.class);
	...
	private ProducerConfig createProducerConfig(){
		Properties defaultProps = DistributionUtil.getKafkaPublishConfig();
	...
	public static void main(String[] args) {
		try {
			new KafkaBasePublisher().publish("data-store",	"Tis is another test data");
