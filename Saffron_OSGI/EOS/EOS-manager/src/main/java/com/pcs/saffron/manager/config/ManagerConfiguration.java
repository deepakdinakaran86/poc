 ...
 *
 */
public class ManagerConfiguration implements PropertyKeys {

	private static Properties props;
	private static final String configFileName = "manager.properties";
	private static final Logger logger = LoggerFactory.getLogger(ManagerConfiguration.class);
	...
	private static URL resolveURL(String path) {
		...
		if (url == null) {
			url = ManagerConfiguration.class.getClassLoader().getResource(path);
		}
		if (url == null) {
