 ...
 * @since galaxy-1.0.0
 */
public class ConfigurationSearch implements Serializable {
...
private static final String DELIMITER = "_";
	...
	public String getId() {
		...
		id.append(DELIMITER).append(make).append(DELIMITER).
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConfigurationSearch other = (ConfigurationSearch)obj;
		if (deviceType == null) {
