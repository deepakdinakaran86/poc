 ...
 *
 */
public class HistoryPollRequest {

	private static final Logger LOGGER = LoggerFactory.getLogger(HistoryPollRequest.class);
	...
	public String getDatapollUrl() {
		return JaceConfiguration.getProperty(JaceConfiguration.DATAPOLL_HISTORY_URL);
	}
	
	public static void main(String[] args) {
		new HistoryPollRequest().getDatapollUrl();
	}
