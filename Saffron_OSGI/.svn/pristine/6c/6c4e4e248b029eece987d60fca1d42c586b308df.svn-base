 ...
 * 
 */
package com.pcs.saffron.manager.config;
...
public interface PropertyKeys {
	...
	static final String CUMMINS_DEVICE_REGISTRATION_URL = "EOS.devicemanager.device.registration.cummins.url";
	...
	static final String CEP_MESSAGE_STREAM = "EOS.cep.message.in";
	static final String MQTT_MESSAGE_STREAM = "EOS.devicemanager.datadistributor.mqttmessagestream";
	static final String MQTT_MESSAGE_PUBLISH_STREAM = "EOS.devicemanager.datadistributor.mqttmessagepublishstream";
	static final String ALARM_ENABLED = "EOS.alarm.enabled";

	static final String ALARM_STREAM = "EOS.devicemanager.datadistributor.alarmstream";
	static final String DEVICE_ACTIVITY_STREAM = "EOS.devicemanager.datadistributor.deviceactivitystream";
	...
	static final String AUTOCLAIM_URL = "EOS.devicemanager.autoclaim.url";
	static final String AUTOCLAIM_IP = "EOS.devicemanager.autoclaim.api.ip";
	static final String AUTOCLAIM_PORT = "EOS.devicemanager.autoclaim.api.port";
	static final String AUTOCLAIM_SCHEME = "EOS.devicemanager.autoclaim.api.scheme";
	
	static final String DATASTOREURL = "EOS.devicemanager.datastore.api.url";
	static final String DATASTORE_IP = "EOS.devicemanager.datastore.api.ip";
	static final String DATASTORE_PORT = "EOS.devicemanager.datastore.api.port";
	static final String DATASTORE_SCHEME = "EOS.devicemanager.datastore.api.scheme";
}
