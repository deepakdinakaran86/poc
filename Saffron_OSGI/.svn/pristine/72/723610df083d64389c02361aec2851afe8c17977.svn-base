...
public class HobbiesMqttEventConnector {


	private static final Logger LOGGER = LoggerFactory.getLogger(HobbiesMqttEventConnector.class);
	...
	private static final String messageTopic = HobbiesGatewayConfiguration.getProperty(HobbiesGatewayConfiguration.MQTT_DEVICE_EVENT_FEED_TOPIC);
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				if(mqttService.start(true)){
					...
					mqttService.subscribe(messageTopic, HANDLER, new MqttDeviceEventTranslator(),qos);
				}else{
	...
	public static void main(String[] args) throws Exception {
		new HobbiesMqttEventConnector().connectToMQTT();
	}
