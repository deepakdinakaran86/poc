 ...
 * @date March 23 2015
 */
public class DiagnosisDistributionUtil {
	
	
	public static String getJmsHost(){
		return ApplicationConfiguration.getDistributionConfig().getDiagJmsHostUrl();
	}
	
	public static String getKafkaBrokers(){
		return ApplicationConfiguration.getDistributionConfig().getDiagKafkaBrokers();
	}
	
	public static String getKafkaBrokerSeeds(){
		return ApplicationConfiguration.getDistributionConfig().getDiagKafkaBrokerSeeds();
	}
	
	public static String getKafkaPort(){
		return ApplicationConfiguration.getDistributionConfig().getDiagKafkaPort();
	}
	
	public static String getZookeeper(){
		return ApplicationConfiguration.getDistributionConfig().getDiagZookeeper();
	}
	
	public static String getZookeeperSessionTimeout(){
		return ApplicationConfiguration.getDistributionConfig().getDiagZookeeperSessionTimeout();
	}
	
	public static String getZookeeperSyncTime(){
		return ApplicationConfiguration.getDistributionConfig().getDiagZookeeperSyncTime();
	}
	
	public static String getKafkaAutoCommitInterval(){
		return ApplicationConfiguration.getDistributionConfig().getDiagKafkaAutoCommitInterval();
	}
	
	public static String getKafkaAutooffsetReset(){
		return ApplicationConfiguration.getDistributionConfig().getDiagKafkaAutooffsetReset();
	}
	
	public static Properties getDiagKafkaPublishConfig(){
	...
	public static Properties getDiagKafkaHLConsumerConfig(){
		Properties properties = new Properties();
	...
	public static CoreConsumer getKafkaHLConsumerConfig(CoreConsumer coreConsumer){
		coreConsumer.setProperties(getDiagKafkaHLConsumerConfig());
		return coreConsumer;
	}
