 ...
 * 
 */
package com.pcs.event.scanner.config;
 ...
 *
 */
public class ScannerConfiguration implements PropertyKeys {

	private static Properties props;
	private static final String configFileName = "amqp.properties";
	private static final Logger logger = LoggerFactory.getLogger(ScannerConfiguration.class);
	...
	private static URL resolveURL(String path) {
		...
		if (url == null) {
			url = ScannerConfiguration.class.getClassLoader().getResource(path);
		}
		if (url == null) {
