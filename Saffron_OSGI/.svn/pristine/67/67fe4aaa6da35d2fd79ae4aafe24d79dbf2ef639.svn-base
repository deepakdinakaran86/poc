...
public class Listeners {
	...
	public void startFromConfiguration(){
		Integer mode = Integer.parseInt(RuptelaGatewayConfiguration.getProperty(RuptelaGatewayConfiguration.START_MODE));
		String delayed = RuptelaGatewayConfiguration.getProperty(RuptelaGatewayConfiguration.START_WITH_DELAY).toUpperCase();
