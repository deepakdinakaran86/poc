 ...
 *
 */
public class JaceConfiguration implements PropertyKeys {

	private static Properties props;
	private static final String configFileName = "gateway.properties";
	private static final Logger logger = LoggerFactory.getLogger(JaceConfiguration.class);
	...
	private static URL resolveURL(String path) {
		...
		if (url == null) {
			url = JaceConfiguration.class.getClassLoader().getResource(path);
		}
		if (url == null) {
