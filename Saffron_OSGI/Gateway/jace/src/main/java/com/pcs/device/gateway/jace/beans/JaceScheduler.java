...
import com.pcs.device.gateway.jace.datapoll.api.DatapollService;
...
public class JaceScheduler implements Job {

	private static final Logger LOGGER = LoggerFactory.getLogger(JaceScheduler.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		DatapollService datapollService = new DatapollService();
		datapollService.pollData(configuration);
	}
