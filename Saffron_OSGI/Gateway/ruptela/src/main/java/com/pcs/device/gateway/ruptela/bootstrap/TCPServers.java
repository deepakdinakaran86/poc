...
import com.pcs.device.gateway.ruptela.handler.tcp.RuptelaTCPHandler;
...
public class TCPServers {
	...
	class ControlServer implements Runnable{
		public void run() {
			...
			frameHandler.setChannelHandlerProvider(RuptelaTCPHandler.class.getName(), null);
			...
			configuration.setPort(Integer.parseInt(RuptelaGatewayConfiguration.getProperty(RuptelaGatewayConfiguration.TCP_CONTROL_SERVER_PORT)));
