...
public class PointDiscoveryRequest {
	...
	public static byte[] getServerMessage(G2021Command command) throws Exception{
		ByteBuffer commandBuffer = ByteBuffer.allocate(14+2);// accommodating packet length
		Integer commandLength = 14;//packet length
		commandBuffer.putShort(commandLength.shortValue());
