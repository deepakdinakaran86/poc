...
public class OperationCommand {
	...
	private static final MessageType MESSAGE_TYPE = MessageType.SYSTEM_COMMAND;
	...
	public static byte[] getServerMessage(G2021Command g2021Command) throws Exception {
		...
		if(commandCode != null){
			ByteBuffer commandBuffer = ByteBuffer.allocate(11+2);
			Integer contentLength = 11;
			commandBuffer.putShort(contentLength.shortValue());
