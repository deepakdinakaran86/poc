...
public class HobbiesMqttCommandResponseConnector {


	private static final Logger LOGGER = LoggerFactory.getLogger(HobbiesMqttCommandResponseConnector.class);
	...
	private static final String messageTopic = HobbiesGatewayConfiguration.getProperty(HobbiesGatewayConfiguration.MQTT_DEVICE_COMMAND_RESPONSE_TOPIC);
	...
	public void connectToMQTT() throws Exception{new Thread(new Runnable() {
		...
		public void run() {
			...
			if(mqttService.start(true)){
				...
				mqttService.subscribe(messageTopic, HANDLER, new MqttDeviceCommandResponseTranslator(),qos);
			}else{
	...
	public static void main(String[] args) throws Exception {
		new HobbiesMqttCommandResponseConnector().connectToMQTT();
	}
