...
public class Constants {
	...
	public static final String INITIAL_CONTEXT_FACTORY = "org.wso2.carbon.tomcat.jndi.CarbonJavaURLContextFactory";
	public static final String DEFAULT_HIERARCHICAL_TENANT_DS = "jdbc/WSO2HierarchicalTenantDB";
	public static final String CARBON_DB = "jdbc/WSO2UM_DB";
	...
	public static final String MODIFY_TENANT_PERMISSION = "/permission/protected/manage/modify/tenants";
	...
	public static final String GET_PARENT_TENANT = "select parent_tenant_id, "
	        + "restriction from tenant_association " + "where tenant_id = ?";
	public static final String CHECK_ASSOCIATION_CREATED = "select association_id from "
	        + "tenant_association " + "where tenant_id = ?";
