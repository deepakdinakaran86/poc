...
public class TokenFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		try {
			...
			if (httpServletRequest.getRequestURI().equals("/template-builder/login")
			        || httpServletRequest.getRequestURI().equals(
			                "/template-builder/authenticate")
			        || httpServletRequest.getRequestURI().equals("/template-builder/")
			        || httpServletRequest.getRequestURI().startsWith(
			                "/template-builder/resources")
			        || httpServletRequest.getRequestURI().startsWith(
			                "/template-builder/webjars")) {
