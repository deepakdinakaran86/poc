...
import com.pcs.web.client.CumminsClient;
import com.pcs.web.client.CumminsClientFactory;
...
public abstract class BaseService {
	...
	@Autowired
	private CumminsClientFactory restTemplateFactory;

	protected Logger logger = LoggerFactory.getLogger(this.getClass()
	        .getSimpleName());

	protected final CumminsClientFactory getRestTemplateFactory() {
		return restTemplateFactory;
	}

	protected final void setRestTemplateFactory(
	        CumminsClientFactory restTemplateFactory) {
		this.restTemplateFactory = restTemplateFactory;
	}

	protected final CumminsClient getPlatformClient() {
