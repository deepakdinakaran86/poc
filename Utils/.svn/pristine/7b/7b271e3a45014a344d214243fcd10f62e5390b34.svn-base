...
import com.pcs.alpine.token.config.TokenManagerConfiguration;
...
public final class TokenManager {
	...
	public static Token getToken(String consumerKey, String secretKey) {
	...
	public static Token getToken(String consumerKey, String secretKey,
		...
		Token token = tokenCache.get(cacheKey, Token.class);
		...
		if (token == null) {
			...
			try {
				...
				if (domainEntityDTO != null) {
					tenant.setPlatformEntityType(domainEntityDTO
	...
	public static Token getToken(String identifier) {
		Cache tokenCache = cacheManager.getCache(TOKEN_CACHE_NAME);
		return tokenCache.get(identifier, Token.class);
	}
