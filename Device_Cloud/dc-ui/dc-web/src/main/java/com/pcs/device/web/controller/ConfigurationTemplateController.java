...
public class ConfigurationTemplateController {
	...
	private static final Logger logger = LoggerFactory
	        .getLogger(ConfigurationTemplateController.class);

	@RequestMapping(value = WebConstants.CONFIGURATION_TEMPLATE_PATH,
	        method = RequestMethod.GET)
	public ModelAndView writeBackPage(HttpServletRequest request) {
		logger.info("configuration tab");
		return new ModelAndView(WebConstants.CONFIGURATION_TEMPLATE_VIEW);
