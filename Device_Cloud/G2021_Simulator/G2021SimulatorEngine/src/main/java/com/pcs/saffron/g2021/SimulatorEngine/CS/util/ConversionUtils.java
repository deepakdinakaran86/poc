...
public class ConversionUtils {
	...
	public static Integer getSequenceNoFromBuffer(byte[]  byteArray) {
		String bufferString = (String) ConversionUtils.getHex(byteArray);		
		String seqNoHex = bufferString.substring(8,10);		
		Integer seqNo = Integer.parseInt(seqNoHex, 16);
		return seqNo;
	}
