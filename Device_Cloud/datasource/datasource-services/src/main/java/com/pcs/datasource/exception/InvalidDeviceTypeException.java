 ...
 * DERIVATIVES.
 */
package com.pcs.datasource.exception;

/**
 * This custom exception class is responsible throwing invalid device type
 * exception while the device communicating to the system is not supported
 * 
