...
/**
 * This class is responsible for Angle extraction
 * 
 * @author pcseg129 (Seena Jyothish)
 * @date March 31 2015
 */
public class Angle_Extractor extends IOExtractor {

	private static Angle_Extractor extractor = null;

	private Angle_Extractor(){

	}

	public static Angle_Extractor getInstance(){
		if(extractor == null){
			extractor = new Angle_Extractor();
		}
		return extractor;
	}
