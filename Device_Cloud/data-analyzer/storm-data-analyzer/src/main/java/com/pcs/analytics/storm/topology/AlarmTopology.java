...
import com.pcs.analytics.storm.bolts.AlarmPersistBolt;
import com.pcs.analytics.storm.scheme.AlarmMessageScheme;
import com.pcs.analytics.util.CustomTopologyBuilder;
import com.pcs.analytics.util.YamlUtils;

/**
 * This class is responsible for providing a topology for persisting alarm messages to a data store
 * 
...
public class AlarmTopology {
	...
	private static void initialize() {
		try {
			...
			LOGGER.error("Error in reading alarm topology configuration", e);
			throw new RuntimeException(e);
		}
	}
	...
	private static StormTopology buildTopology() {
		...
		builder.setBolt(persistBoltName, new AlarmPersistBolt(publisherConfFilePath),
