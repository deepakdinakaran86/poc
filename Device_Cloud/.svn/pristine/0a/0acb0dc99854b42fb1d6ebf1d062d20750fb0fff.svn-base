 ...
 * 
 */
package com.pcs.device.gateway.G2021.devicemanager.session;
...
public final class SessionManager {
	...
	public SessionInfo getSessionByPrincipal(Object principal) {
		Cache deviceSessionCache = getCacheProvider().getCache(G2021GatewayConfiguration.DEVICE_SESSION_CACHE);
	...
	private Long getTimeOutValueInSeconds() {
		Long timeout = Long.valueOf(G2021GatewayConfiguration
		        .getProperty(G2021GatewayConfiguration.DEVICE_SESSION_CACHE_TIMEOUT));
		return timeout;
	}
