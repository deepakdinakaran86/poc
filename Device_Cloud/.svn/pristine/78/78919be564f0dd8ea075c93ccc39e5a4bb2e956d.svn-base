...
import com.pcs.data.analyzer.storm.bolts.DataPersistBolt;
import com.pcs.data.analyzer.storm.bolts.EventAnalyzerPublisherBolt;
import com.pcs.data.analyzer.storm.bolts.PushServicePublisherBolt;
...
public class DistributorTopology {
	 ...
	 * @return
	 */
	private static KafkaSpout buildKafkaSpout(String parentSpoutName) {
		...
		kafkaConfig.scheme = new SchemeAsMultiScheme(new MessageScheme(parentSpoutName));
