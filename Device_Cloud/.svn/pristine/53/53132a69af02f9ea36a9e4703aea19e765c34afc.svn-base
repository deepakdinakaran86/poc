package com.pcs.device.gateway.meitrack.devicemanager.auth.api;
...
import com.pcs.device.gateway.meitrack.devicemanager.bean.Device;
import com.pcs.device.gateway.meitrack.devicemanager.bean.Status;
import com.pcs.device.gateway.meitrack.devicemanager.bean.StatusType;
...
public class DeviceAuthenticationService implements AuthenticationService {
	...
	private AuthenticationLifeCycle processResponse(String sourceIdentifier, DeviceAuthenticationResponse response,
		...
		case ACTIVE:
			MeitrackDeviceConfiguration config = new MeitrackDeviceConfiguration();
