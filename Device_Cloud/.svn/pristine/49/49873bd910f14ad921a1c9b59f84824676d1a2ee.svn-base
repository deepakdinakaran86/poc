...
/**
 * This class is responsible for GSM Signal Strength extraction
 * 
 * @author pcseg129 (Seena Jyothish)
 * @date March 31 2015
 */
public class Gsm_Signal_Strength_Extractor extends IOExtractor {

	private static Gsm_Signal_Strength_Extractor extractor = null;

	private Gsm_Signal_Strength_Extractor(){
	}

	public static Gsm_Signal_Strength_Extractor getInstance(){
		if(extractor == null){
			extractor = new Gsm_Signal_Strength_Extractor();
		}
		return extractor;
	}
