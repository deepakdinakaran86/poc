	...
	public Message identifyPoints() throws Exception {
		...
		try {
			...
			if (configuration != null) {
				...
				Collections.sort(configPoints,
						new DeviceConfigurationComparator());
				...
				for (ConfigPoint configPoint : configPoints) {
					...
					if (devicePoint != null) {
						...
						try {
							...
							Object evaluatedValue = ExpressionEngineUtil.evaluate(expression, parameterMap);
