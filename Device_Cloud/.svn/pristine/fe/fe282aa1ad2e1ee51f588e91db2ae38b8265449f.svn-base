...
/**
 * This class is responsible for Visible Satellites extraction
 * 
 * @author pcseg129 (Seena Jyothish)
 * @date March 31 2015
 */
public class Visible_Satellites_Extractor extends IOExtractor {
	
	private static Visible_Satellites_Extractor extractor = null;

	private Visible_Satellites_Extractor(){
	}

	public static Visible_Satellites_Extractor getInstance(){
		if(extractor == null){
			extractor = new Visible_Satellites_Extractor();
		}
		return extractor;
	}
