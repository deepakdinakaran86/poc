...
public final class SessionManager {
	...
	public SessionInfo getSessionByPrincipal(Object principal) {
		Cache deviceSessionCache = getCacheProvider().getCache(TeltonikaGatewayConfiguration.DEVICE_SESSION_CACHE);
	...
	private Long getTimeOutValueInSeconds() {
		Long timeout = Long.valueOf(TeltonikaGatewayConfiguration
		        .getProperty(TeltonikaGatewayConfiguration.DEVICE_SESSION_CACHE_TIMEOUT));
		return timeout;
	}
