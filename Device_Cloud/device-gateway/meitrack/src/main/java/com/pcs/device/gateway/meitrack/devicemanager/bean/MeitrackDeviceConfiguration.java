...
public class MeitrackDeviceConfiguration extends DeviceConfiguration {
	...
	public MeitrackDeviceConfiguration(String sourceIdentifier,Integer unitId,Integer sessionId,String ccKey){
	...
	public MeitrackDeviceConfiguration() {
	}
