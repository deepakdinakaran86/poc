...
public class TeltonikaDeviceConfiguration extends DeviceConfiguration {
	...
	public TeltonikaDeviceConfiguration(String sourceIdentifier,Integer unitId,Integer sessionId,String ccKey){
	...
	public TeltonikaDeviceConfiguration() {
	}
