 ...
 * @since galaxy-1.0.0
 */
public class DeviceDataTransformNPublishBolt extends BaseBasicBolt {

	private static Logger LOGGER = LoggerFactory
			.getLogger(DeviceDataTransformNPublishBolt.class);
	...
	public DeviceDataTransformNPublishBolt(String publisherConfFilePath,
		...
		if (input.getValues().get(1) != null
			...
			try {
				...
				if (msg != null) {
					...
					collector.emit(new Values(msg.getSourceId(),msg));
				}
			} catch (Exception e) {
