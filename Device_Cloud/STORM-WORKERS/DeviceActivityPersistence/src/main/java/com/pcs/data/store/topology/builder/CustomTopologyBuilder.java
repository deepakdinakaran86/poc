...
public class CustomTopologyBuilder {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CustomTopologyBuilder.class);
	...
	private Config createConfiguration() {
		...
		config.put(Config.TOPOLOGY_TRIDENT_BATCH_EMIT_INTERVAL_MILLIS, tupleEmitTimeout);
		config.put(CassandraCqlStateFactory.TRIDENT_CASSANDRA_MAX_BATCH_SIZE, stormConfig.getCassandraBatchSize());
