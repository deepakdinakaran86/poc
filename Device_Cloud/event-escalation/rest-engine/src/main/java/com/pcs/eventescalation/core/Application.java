 ...
 * DERIVATIVES.
 */
package com.pcs.eventescalation.core;
...
import com.pcs.eventescalation.listeners.JmsAsyncListener;

/**
 * This class is responsible for setting the application configuration for rest
...
public class Application {
	...
	private static void loadQueueProperties() {
		...
		try {
			...
			LOGGER.error("Error in reading queue.properties for rest notification");
		}
