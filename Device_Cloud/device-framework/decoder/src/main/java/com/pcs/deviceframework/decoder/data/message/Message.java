 ...
 * 
 */
package com.pcs.deviceframework.decoder.data.message;
...
public class Message implements Serializable{
	...
	public String toString() {
		...
		//sourceId = "efc79f2b-2487-484d-ac24-b625bb88319b";
		...
		for (Point point : points) {
			...
			if(!CollectionUtils.isEmpty(point.getAlarmExtensions())){
				...
				for (AlarmExtension alarmExtension : point.getAlarmExtensions()) {
					...
					messageBuilder.append("\"alarmState\":\"").append(alarmExtension.getState()).append("\",");
					messageBuilder.append("\"alarmType\":\"").append(alarmExtension.getType()).append("\",");
