...
public enum GalaxyValidationDataFields {
	...
	MANDATORY("mandatory"), UNIQUE_ACROSS_DOMAIN("uniqueAcrossDomain"), UNIQUE_ACROSS_APPLICATION(
			"uniqueAcrossApplication"), SHOW_ON_TREE("showOnTree"), SHOW_ON_GRID(
			"showOnGrid"),UNIQUE_ACROSS_HIERARCHY("uniqueAcrossHierarchy");
