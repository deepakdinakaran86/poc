...
public enum GalaxyCommonErrorCodes implements GalaxyErrorCode {
	...
	ROUTE_EXIST(757, "Route Exist",
			"Route Name already exist"),
	
	NO_ROUTE_EXIST(758, "No Route Exist",
			"No Route exist under this domain"),
	
	INVALID_TIME_FRMT(759, "Invalid Time Format",
			" Invalid"),
	
	INVALID_END_TIME(760, "EndTime is Invalid",
			" Invalid EndTime"),
	
	INVALID_START_TIME(761, "StartTime is Invalid",
			" Invalid StartTime"),
			
	INVALID_TIME_RANGE(762, "TimeRange is Invalid",
					" Invalid TimeRange"),
	
	INVALID_DAY_SPAN(763, "DaySpan is Invalid",
							" Invalid DaySpan"),
	
	INVALID_NO_POI(764, "Poi count is Invalid",
									" Invalid No of POI"),
	
	INVALID_POI_NAME(765, "Poi name is Invalid",
											" Invalid POI name specified")
