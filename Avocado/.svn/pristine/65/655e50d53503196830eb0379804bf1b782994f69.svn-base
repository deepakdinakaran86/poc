...
public enum EquipmentDataFields implements DataFields {
	...
	PLATFORM_ENTITY_TYPE("platformEntityType", "platformEntityType",
	...
	EQUIPMENT("equipment", "equipment", "Equipment"), EQUIP_IDENTIFIER_KEY(
	        "key", "key", "Equipment Identifier Key"),
	...
	EQUIP_ENTITY_TEMPLATE("entityTemplate", "entityTemplate",
	        "Equipment Entity Template"),
	...
	DEVICE_ENTITY_TEMPLATE_NAME("entity_template_name", "entityTemplateName",
	        "Device Entity Template Name"), DEVICE_ENTITY_TEMPLATE(
	        "entityTemplate", "entityTemplate", "Device Entity Template"),
	...
	EQUIP_IDENTITY("equipIdentifier", "equipIdentifier", "Equipment Identifier");
