...
public class ResourceConstants {
	...
	public static final String EQUIPMENT_IDENTITY = "Equipment Identity";
	public static final String ASSET_PAYLOAD = "Asset Payload";
	public static final String ASSET_NAME = "Asset Name";

	public static final String POINTS_NOT_UNIQUE = "Points are not unique";
