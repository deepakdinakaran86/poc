...
public class ClientDeviceDTO {
	...
	private List<EntityDTO> devices;
	private IdentityDTO parent;

	public List<EntityDTO> getDevices() {
		return devices;
	}

	public void setDevices(List<EntityDTO> devices) {
		this.devices = devices;
	}

	public IdentityDTO getParent() {
		return parent;
	}

	public void setParent(IdentityDTO parent) {
		this.parent = parent;
	}
