 ...
 * DERIVATIVES.
 */
package com.pcs.avocado.commons.service;
...
/**
 * SubscriptionProfileService Interface is a service contract for
 * SubscriptionProfile Services.
 * 
 * @author Twinkle(PCSEG297)
 * @date September 2015
 * @since galaxy-1.0.0
 */
public interface SubscriptionProfileService {
