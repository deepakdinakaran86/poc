 ...
 * DERIVATIVES.
 */
package com.pcs.avocado.commons.email.serviceimpl;

import static com.pcs.avocado.enums.CommonFields.CONTENT;
import static com.pcs.avocado.enums.CommonFields.DOMAIN_NAME;
import static com.pcs.avocado.enums.CommonFields.EMAIL_TEMPLATE;
import static com.pcs.avocado.enums.CommonFields.SUBJECT;
import static com.pcs.avocado.enums.CommonFields.TO;
import static com.pcs.avocado.enums.CommonFields.TO_ADDRESS;
import static com.pcs.avocado.enums.CommonFields.URL;
import static com.pcs.avocado.enums.CommonFields.USER_NAME;
...
import com.pcs.avocado.commons.email.helper.MailUtil;
import com.pcs.avocado.commons.email.service.EmailService;
...
public class EmailServiceImpl implements EmailService {
	...
	public void sendEmail(EmailDTO emailDTO) {
		...
		try {
			...
			String domain = null;
			if(emailDTO.getUserName()!=null && !isBlank(emailDTO.getUserName())){
			...
			model.put(TO.getFieldName(), (WordUtils.capitalize(emailDTO.getTo())));
			...
			LOGGER.info("*****{},{},{}",emailDTO.getTo(),emailDTO.getContent(),emailDTO.getToAddresses());

			mail.sendMailWithTemplate(model, emailDTO.getEmailTemplate(),emailDTO.getSubject(),emailDTO.getToAddresses());
