...
public interface WebConstants {
	...
	// Resource
	final static String RESOURCE_HOME = "resource_home";
	final static String RESOURCE_FORM = "resource_form";
	final static String RESOURCE_VIEW = "resource_view";
	final static String RESOURCE_CREATE = "resource_create";
