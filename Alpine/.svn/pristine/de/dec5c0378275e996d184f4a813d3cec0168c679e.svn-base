...
public enum HMDataFields implements DataFields {
	...
	LONGITUDE("longitude", "longitude", "Longitude"), PARENT("parent",
	        "parent", "Parent"), CHILD_V("child", "child", "Child"), ACTORS(
	        "actors", "actors", "Actors"), TAG_TYPE("tagType", "tagType",
	        "Tag Type"), END_TEMPLATE("endEntityTemplate", "endEntityTemplate",
	        "End Entity Template"), INTERMEDIATE_TEMPLATES(
	        "intermediateTemplates", "intermediateTemplates",
	        "Intermediate Templates"), NAME("name", "name", "Name");
