...
public interface RoleService {
	...
	public StatusMessageDTO updateRole(RoleDTO role);

	public StatusMessageDTO deleteRole(String roleName, String domainName);

	/**
	 * Service Method to fetch all the permissions of the current user
	 * 
	 * Subscription Context will be used to fetch the user info and then the
	 * corresponding role info will be fetched
	 * 
	 * @return
	 */
