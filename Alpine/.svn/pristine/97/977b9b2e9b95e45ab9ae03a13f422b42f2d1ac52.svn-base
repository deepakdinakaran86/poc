...
public enum UMDataFields implements DataFields {
	...
	LAST_NAME("lastName", "lastName", "Last Name"), DESIGNATION("designation",
	        ...
	        "value", "value", "Value"), GLOBAL_ENTITY_DTO("globalEntityDTO",
	        "globalEntityDTO", "Global Entity DTO"), GLOBAL_ENTITY_TYPE(
	        "global_entity_type", "globalEntityType", "Global Entity Type"),
	GLOBAL_ENTITY("global_entity", "globalEntity", "Global Entity"),
