...
public enum GalaxyCommonErrorCodes implements GalaxyErrorCode {
	...
	CREATE_APPLICATION_FAILURE(514, " Create application has failed. ",
	        " Create application has failed. "),
	...
	NO_ACCESS_SELECTED_TENANT(606, "User has no access to the selected tenant",
	    	        "User has no access to the selected tenant"),
	...
	WEB_SOCKET_CONNECTION_NOT_AVAILABLE(752,
	        ...
	        "Web Socket connection is not available"), TENANT_LINK_NOT_ALLOWED(
	        753, "Tenant cant be linked with any parent",
	        "Tenant cant be linked with any parent"),
	ENTITIES_FROM_WRONG_HIERARCHY(753, "Entities are with wrong hierarchy",
	        "Entities are with wrong hierarchy"), ROLE_NAME_CANNOT_BE_UPDATED(
	        754, "Role name cannot be updated", "Role name cannot be updated"),
	ROLE_NAMES_SHOULD_BE_JSON_ARRAY(754, "Role name should be json array",
	        "Role name should be json array"), CYCLIC_ATTACHMENT_NOT_ALLOWED(
	        755, "Cyclic attachment not allowed",
	        "Cyclic attachment not allowed"), 
