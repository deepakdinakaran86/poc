...
public class GetConfigurationInfo {
    ...
    @XmlElementRef(name = "domainName", namespace = "http://admin.manager.execution.event.carbon.wso2.org", type = JAXBElement.class, required = false)
    protected JAXBElement<String> domainName;
    @XmlElementRef(name = "configName", namespace = "http://admin.manager.execution.event.carbon.wso2.org", type = JAXBElement.class, required = false)
