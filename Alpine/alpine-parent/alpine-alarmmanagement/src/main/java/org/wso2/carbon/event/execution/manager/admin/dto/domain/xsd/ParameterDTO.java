...
public class ParameterDTO {
    ...
    @XmlElementRef(name = "defaultValue", namespace = "http://domain.dto.admin.manager.execution.event.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "displayName", namespace = "http://domain.dto.admin.manager.execution.event.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "options", namespace = "http://domain.dto.admin.manager.execution.event.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> options;
    @XmlElementRef(name = "type", namespace = "http://domain.dto.admin.manager.execution.event.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
