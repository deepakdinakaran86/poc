...
<script type="text/javascript">
		...
		$.ajax({
			...
			success : function(response) {
				...
				if (response.entity != null) {
					...
					var deviceSelected = '${commuter_form.device}';
					if (deviceSelected != '') {
	...
	function submitAction() {
		$("#commuter_form").submit();
	}
</script>
<div style="height: 1px;">
	<form id="commuterHome" action="commuter_home" method="get"></form>
</div>

<form:form role="form" action="commuter_create" commandName="commuter_form"
	id="commuter_form" autocomplete="off" novalidate="novalidate">
...
<div>
	<button class="button text-shadow large-button fg-white bg-blue "
		style="height: 40px; width: 80px;" id="commuter-btn-save"
...
<script type="text/javascript">
	...
	if ('${action}' === 'View') {
		$("#commuter_form :input").prop("disabled", true);
		$("#commuter-btn-save").hide();
	} else {
		setFormValidation();
		entityName = '${commuter_form.entityName}';
		esn = '${commuter_form.esn}';
	}
