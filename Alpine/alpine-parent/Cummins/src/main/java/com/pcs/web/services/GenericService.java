...
public class GenericService extends BaseService {
	...
	public CumminsResponse<JsonNode> getObject(String url) {
		String serviceUri = getServiceURI(url);
		return getPlatformClient().getResource(serviceUri, JsonNode.class);
	}

	public CumminsResponse<JsonNode> postObject(String url, Object payload) {
		String serviceUri = getServiceURI(url);
		return getPlatformClient().postResource(serviceUri, payload,
		        JsonNode.class);
	}

	public CumminsResponse<JsonNode> putObject(String url, Object payload) {
		String serviceUri = getServiceURI(url);
		return getPlatformClient().putResource(serviceUri, payload,
		        JsonNode.class);
	}

	public CumminsResponse<JsonNode> deleteObject(String url) {
		String serviceUri = getServiceURI(url);
