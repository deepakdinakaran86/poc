...
public class EntityAssignDTO {
	...
	public String getMarkerTemplateName() {
		return markerTemplateName;
	}
	public void setMarkerTemplateName(String markerTemplateName) {
		this.markerTemplateName = markerTemplateName;
	}
