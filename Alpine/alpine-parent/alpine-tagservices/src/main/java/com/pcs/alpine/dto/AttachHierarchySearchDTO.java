...
/**
 * AttachHierarchySearchDTO
 * 
 * @author Twinkle (PCSEG297)
 * @date May 2016
 * @since galaxy-1.0.0
 */
public class AttachHierarchySearchDTO implements Serializable {
	...
	private List<EntityTemplateDTO> searchTemplates;
	...
	public List<EntityTemplateDTO> getSearchTemplates() {
	    return searchTemplates;
    }

	public void setSearchTemplates(List<EntityTemplateDTO> searchTemplates) {
